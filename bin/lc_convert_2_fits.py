...
# out_filename = '/data17s/darksim/MD/MD_1.0Gpc/h5_lc/lc_remaped_position_L3.fits'
# z_min = 0.
# z_max = 1.08
...
#out_filename = '/data17s/darksim/MD/MD_1.0Gpc/h5_lc/lc_remaped_position_L3_z1.fits'
#z_min = 1.08
#z_max = 3.0
...
hdu_cols  = fits.ColDefs([
 fits.Column(name='is_agn',format='K',array= (f['/agn_properties/agn_activity'].value[is_gal]).astype('int') ) 
,fits.Column(name='logNH',format='D',    array= f['/agn_properties/logNH'].value[is_gal] ) 
,fits.Column(name='log_lambda_sar',format='D',    array= f['/agn_properties/log_lambda_sar'].value[is_gal] ) 
,fits.Column(name='rxay_flux_05_20',format='D',    array= f['/agn_properties/rxay_flux_05_20'].value[is_gal] ) 
,fits.Column(name='Mpeak',format='D',    array= f['/halo_properties/Mpeak'].value[is_gal] ) 
,fits.Column(name='Vmax',format='D',    array= f['/halo_properties/Vmax'].value[is_gal] ) 
,fits.Column(name='mvir',format='D',    array= f['/halo_properties/mvir'].value[is_gal] ) 
,fits.Column(name='id',format='K',    array= (f['/halo_properties/id'].value[is_gal]).astype('int') ) 
,fits.Column(name='pid',format='K',    array= (f['/halo_properties/pid'].value[is_gal]).astype('int')  ) 
,fits.Column(name='moster_2013_data',format='D', array= f['/moster_2013_data/stellar_mass'].value[is_gal]  ) 
,fits.Column(name='RA',format='D',    array= f['/sky_position/RA'].value[is_gal]  ) 
,fits.Column(name='DEC',format='D',    array= f['/sky_position/DEC'].value[is_gal]  ) 
,fits.Column(name='redshift_R',format='D',    array= f['/sky_position/redshift_R'].value[is_gal] ) 
,fits.Column(name='redshift_S',format='D',    array= f['/sky_position/redshift_S'].value[is_gal] ) 
])
