...
def get_data(ii):
	...
	DATA = n.array([
		...
		f1['/cluster_data/cool_class'].value,
		f1['/cluster_data/kT'].value,
		f1['/cluster_data/log_LX_05_24'].value,
		f1['/cluster_data/log_LceX_05_24'].value,
		f1['/cluster_data/log_Mgas'].value,
		#  HALO PROPERTIES
		f1['halo_properties/scale']                          .value,
		f1['halo_properties/id']                             .value,
		f1['halo_properties/desc_scale']                     .value,
		f1['halo_properties/desc_id']                        .value,
		f1['halo_properties/num_prog']                       .value,
		f1['halo_properties/pid']                            .value,
		f1['halo_properties/upid']                           .value,
		f1['halo_properties/desc_pid']                       .value,
		f1['halo_properties/mvir']                           .value,
		f1['halo_properties/rvir']                           .value,
		f1['halo_properties/rs']                             .value,
		f1['halo_properties/vrms']                           .value,
		f1['halo_properties/mmp']                            .value,
		f1['halo_properties/scale_of_last_MM']               .value,
		f1['halo_properties/vmax']                           .value,
		f1['halo_properties/Jx']                             .value,
		f1['halo_properties/Jy']                             .value,
		f1['halo_properties/Jz']                             .value,
		f1['halo_properties/Spin']                           .value,
		f1['halo_properties/Breadth_first_ID']               .value,
		f1['halo_properties/Depth_first_ID']                 .value,
		f1['halo_properties/Tree_root_ID']                   .value,
		f1['halo_properties/Orig_halo_ID']                   .value,
		f1['halo_properties/Next_coprogenitor_depthfirst_ID'].value,
		f1['halo_properties/Last_progenitor_depthfirst_ID']  .value,
		f1['halo_properties/Last_mainleaf_depthfirst_ID']    .value,
		f1['halo_properties/Tidal_Force']                    .value,
		f1['halo_properties/Tidal_ID']                       .value,
		f1['halo_properties/Rs_Klypin']                      .value,
		f1['halo_properties/Mmvir_all']                      .value,
		f1['halo_properties/M200b']                          .value,
		f1['halo_properties/M200c']                          .value,
		f1['halo_properties/M500c']                          .value,
		f1['halo_properties/M2500c']                         .value,
		f1['halo_properties/Xoff']                           .value,
		f1['halo_properties/Voff']                           .value,
		f1['halo_properties/Spin_Bullock']                   .value,
		f1['halo_properties/b_to_a']                         .value,
		f1['halo_properties/c_to_a']                         .value,
		f1['halo_properties/Ax']                             .value,
		f1['halo_properties/Ay']                             .value,
		f1['halo_properties/Az']                             .value,
		f1['halo_properties/b_to_a_500c']                    .value,
		f1['halo_properties/c_to_a_500c']                    .value,
		f1['halo_properties/Ax_500c']                        .value,
		f1['halo_properties/Ay_500c']                        .value,
		f1['halo_properties/Az_500c']                        .value,
		f1['halo_properties/TU']                             .value,
		f1['halo_properties/M_pe_Behroozi']                  .value,
		f1['halo_properties/M_pe_Diemer']                    .value,
		f1['halo_properties/Macc']                           .value,
		f1['halo_properties/Mpeak']                          .value,
		f1['halo_properties/Vacc']                           .value,
		f1['halo_properties/Vpeak']                          .value,
		f1['halo_properties/Halfmass_Scale']                 .value,
		f1['halo_properties/Acc_Rate_Inst']                  .value,
		f1['halo_properties/Acc_Rate_100Myr']                .value,
		f1['halo_properties/Acc_Rate_1Tdyn']                 .value,
		f1['halo_properties/Acc_Rate_2Tdyn']                 .value,
		f1['halo_properties/Acc_Rate_Mpeak']                 .value,
		f1['halo_properties/Mpeak_Scale']                    .value,
		f1['halo_properties/Acc_Scale']                      .value,
		f1['halo_properties/First_Acc_Scale']                .value,
		f1['halo_properties/First_Acc_Mvir']                 .value,
		f1['halo_properties/First_Acc_Vmax']                 .value,
		f1['halo_properties/VmaxAtMpeak']                    .value,
		f1['halo_properties/Tidal_Force_Tdyn']               .value,
		f1['halo_properties/logVmaxVmaxmaxTdynTmpeak']       .value,
		f1['halo_properties/Time_to_future_merger']          .value,
		f1['halo_properties/Future_merger_MMP_ID']           .value
		])
	f.close()
	return DATA
