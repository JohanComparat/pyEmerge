...
class MultiDarkSimulation :
	...
	def convert_to_h5_format_cluster(self, snap_name, path_2_h5_file, aexp, redshift):
		...
		scale                             ,		id                                ,		desc_scale                        ,		desc_id                           ,		num_prog                          ,		pid                               ,		upid                              ,		desc_pid                          ,		phantom                           ,		sam_mvir                          ,		mvir                              ,		rvir                              ,		rs                                ,		vrms                              ,	mmp                               ,		scale_of_last_MM                  ,		vmax                              ,		x                                 ,		y                                 ,		z                                 ,		vx                                ,		vy                                ,		vz                                ,		Jx                                ,		Jy                                ,		Jz                                ,		Spin                              ,		Breadth_first_ID                  ,
		Depth_first_ID                    ,		Tree_root_ID                      ,	Orig_halo_ID                      ,		Snap_num                          ,		Next_coprogenitor_depthfirst_ID   ,		Last_progenitor_depthfirst_ID     ,		Last_mainleaf_depthfirst_ID       ,		Tidal_Force                       ,		Tidal_ID                          ,		Rs_Klypin                         ,		Mmvir_all                         ,		M200b                             ,		M200c                             ,		M500c                             ,		M2500c                            ,		Xoff                              ,		Voff                              ,		Spin_Bullock                      ,		b_to_a                            ,		c_to_a                            ,		Ax                                ,		Ay                                ,		Az                                ,		b_to_a_500c                       ,		c_to_a_500c                       ,		Ax_500c                           ,		Ay_500c                           ,		Az_500c                           ,		TU                                ,		M_pe_Behroozi                     ,		M_pe_Diemer                       ,		Macc                              ,		Mpeak                             ,		Vacc                              ,		Vpeak                             ,		Halfmass_Scale                    ,		Acc_Rate_Inst                     ,		Acc_Rate_100Myr                   ,		Acc_Rate_1Tdyn                    ,		Acc_Rate_2Tdyn                    ,		Acc_Rate_Mpeak                    ,		Mpeak_Scale                       ,		Acc_Scale                         ,		First_Acc_Scale                   ,		First_Acc_Mvir                    ,		First_Acc_Vmax                    ,		VmaxAtMpeak                       ,		Tidal_Force_Tdyn                  ,		logVmaxVmaxmaxTdynTmpeak          ,		Time_to_future_merger             ,		Future_merger_MMP_ID      =  n.loadtxt(path_2_snap, unpack=True, dtype = dtype1)
